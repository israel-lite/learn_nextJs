...
export default function DivededComponentOne() {
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#101a33] flex items-center justify-between pl-8 lg:pl-20 pr-0 py-12 rounded-[32px]">
      <div className="w-full max-w-[680px] z-10 flex flex-col gap-12">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#3b4e8e] flex items-center justify-center text-white font-bold">
                <Image 
                src="/Avatar.png" 
                alt="main logo" 
                width={22} 
        ...
        <div className="flex flex-col gap-6">
          <h1 className="text-6xl lg:text-7xl font-bold tracking-tight text-white">
            Supa <span className="text-[#6c5ce7]">Resume</span>
          </h1>
          <p className="text-2xl font-medium text-slate-300 leading-relaxed max-w-[540px]">
        ...
        /> */}
          ...
          <motion.div 
            ...
            className="bg-white border border-slate-100/80 p-7 rounded-[24px] flex flex-col gap-8 shadow-[0_8px_30px_rgb(0,0,0,0.02)]"
          >
            <div className="w-12 h-12 rounded-full bg-[#232f5d] flex items-center justify-center">
              <Image 
                src="/autolayout.png" 
      ...
      <div className="relative h-screen w-[420px] min-w-[420px] border-l border-[#74b9ff]/40 bg-white/40 backdrop-blur-sm shadow-2xl flex-shrink-0 translate-x-4">
        <div className="p-8 flex flex-col gap-6 h-full">
          ...
          <div className="bg-[#151f45]/80 p-4 rounded-xl border border-slate-100 italic text-sm text-slate-300 relative">
          ...
          <div className="flex flex-col gap-4 mt-4">
            <div className="flex items-center gap-3 text-sm text-slate-300">
              <div className="w-8 h-8 rounded-lg bg-[#1f2d5c] flex items-center justify-center">
                ✉️
              </div>
          ...
          <div className="border-t border-[#24315f] my-2"></div>

          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3 text-sm text-slate-300">
              <div className="w-8 h-8 rounded-lg bg-[#1f2d5c] flex items-center justify-center overflow-hidden">
